...
var ravencorenode = require('..');
var utils = require('../utils');

function main(servicesPath, additionalServices) {
  /* jshint maxstatements: 100 */

  var version = ravencorenode.version;
  var create = ravencorenode.scaffold.create;
  var add = ravencorenode.scaffold.add;
  var start = ravencorenode.scaffold.start;
  var remove = ravencorenode.scaffold.remove;
  var callMethod = ravencorenode.scaffold.callMethod;
  var findConfig = ravencorenode.scaffold.findConfig;
  var defaultConfig = ravencorenode.scaffold.defaultConfig;
  ...
  program
    ...
    .action(function(services){
      ...
      if (!configInfo) {
        throw new Error('Could not find configuration, see `ravencore-node create --help`');
      }
      var opts = {
      ...
      console.log();
      console.log('    $ ravencore-node add wallet-service');
      console.log('    $ ravencore-node add insight-api');
      console.log();
    });
  ...
  program
    ...
    .action(function(services){
      ...
      console.log('  Examples:');
      console.log();
      console.log('    $ ravencore-node remove wallet-service');
      console.log('    $ ravencore-node remove insight-api');
      console.log();
    });
